...
const Navbar = ({ visibleSearch, presentPage }) => {
    ...
    const handleClick = () => {
        ...
        dispatch(logoutUser(decoded.auth_token));
        navigate("/");
    };
    ...
    return (
        <div className="container-nav">
            ...
            <div className="a">
                ...
                <p className="log_out" on onClick={handleClick}>
                    Logout
                </p>
            </div>
                ...
                {toggleMenu && (
                    <div className="nav_mobile_menu scale-up-center">
                        <div className="nav_mobile_menu_part">
                            ...
                            <p>
                                <Link className="nav-profile" to="/sideBar">
                                    Profile
                                </Link>
                            </p>
                            <p>
                        ...
                        <div className="nav_mobile_menu_sign">
                            <p className="log_out_menu" on onClick={handleClick}>
                                LogOut
                            </p>
                        </div>
                    </div>
