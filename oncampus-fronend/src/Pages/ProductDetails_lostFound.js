...
function LostFoundItemDetails() {
    ...
    const raisedHandResponse = useSelector((state) => state.lostFound.raisedHandResponse);
    const deleteLostFoundItemResponse = useSelector((state) => state.lostFound.deleteLostFoundItemResponse);
    ...
    useEffect(() => {
        ...
        dateString()
    }, [product_id, product?.lost_date, dispatch, decoded]);
    ...
    return (
        <>
            ...
            <div className="LostItemMaincontainer">
                <div className="LostItemDetailsContainerWrapper">
                    <div className="headingContainer">
                        ...
                        {product?.owner_details?._id === user_details._id ? (
                            <div className="buttonContainer" style={{ display: "flex", height: "70%" }}>
                                <Button
                                    size="medium"
                                    variant="contained"
                                    color="primary"
                    ...
                    <div className="LostItemDetailsContainer">
                        <div className="firstHalf">
                            ...
                            <div className="LostDetailsListItem">
                                <h4 style={{ fontFamily: "Hind Siliguri,sans-serif", fontWeight: "700" }}>
                                    Primary Color
                                </h4>
                                <p>{product?.color}</p>
                            </div>
                    ...
                    <div style={modalStyle} className={`${classes.paper}`}>
                        ...
                        >
                            <div className="inputDiv">
                                <label htmlFor="description" className="form-label" style={{ marginBottom: "10px" }}>
                                    Note (optional)
                                </label>
                                <textarea
                                    id="descripion"
                            ...
                            <Button
                                ...
                                variant="contained"
                                // disabled={isLoading}
                                style={{ marginLeft: "2%", width: "100%", padding: "0.5rem 0.5rem"}}
                            >
                                Submit  
                            </Button>
                        </form>
                ...
                >
                    <div style={modalStyle} className={`${classes.paper}`}>
                        <h4 style={{ fontFamily: "Helvetica", fontWeight: "600" }} className="label">
                            Delete Lost Item
                        </h4>
                        <p
                            style={{
