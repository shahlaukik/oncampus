      ...
      {modal && (
        <div className="modal">
          ...
          <div className="modal-content">
            <h2 style={{ color: "#181818",fontFamily:"Inconsolata,sans-serif",fontweight:'700', marginTop:"2rem" }}>Add Requirement</h2>
            <form style={{display:'flex',flexDirection:'column',alignItems:'center'}}  onSubmit={handleSubmit}>
              <label style={{fontFamily:"Inter,sans-serif",fontweight:'900',marginTop:'15px'}} htmlFor="input">Title</label>
                
              <input onChange={(e) => setTitle(e.target.value)} type="text" style={{padding:"0.5rem 1rem"}}/>
              ...
              <button style={{width:'13rem',color:'white',fontFamily: "Inter, monospace",background:'#181818',borderRadius:'10px',margin:'20px',height:'2.5rem',fontWeight:'700'}}>Submit</button>
              <p>{errorMessage4}</p>
            </form>
