...
export const verifyEmail=(email)=>async (dispatch)=>{
    ...
    try {
        const emailResponse=await axios.post(
            "http://localhost:8080/auth/send-email-register-otp",{
                email:email
            }
...
export const verifyEmailForReset=(email)=>async (dispatch)=>{
    ...
    try {
        const emailResponseforReset=await axios.post(
            "http://localhost:8080/auth/send-forgot-password-otp",{
                email:email
            }
...
export const logoutUser= (token)=> async (dispatch) => {
    ...
    export const editProfile= (formData)=> async (dispatch) => {
        ...
        try {
         ...
         const res=  await axios.put(
            "http://localhost:8080/auth/edit-profile",formData
 ...
 try{
        ...
        const res = await axios.get(
          ...
          "http://localhost:8080/auth/get-dashboard-statistics",{
            headers:{
              authorization:`Bearer ${decoded.auth_token}`,
            },
          }
