    ...
    return (
        <div style={{ fontWeight: "600" }} className="profile-page-container">
            <div className="profile-page">
                ...
                <div className="top-section" style={{padding: "2rem"}}>
                ...
                <div className="bottom-section">
                    <div className="leftpart">
                        <div className="profile-page__field">
                            <span className="more_details">
                                <FaRegCalendarAlt /> Year: {decoded.year}
                            </span>
                        </div>
                        <div className="profile-page__field">
                            <span className="more_details">
                                <FaRegBookmark /> Batch: {decoded.batch}
                            </span>
                        </div>
                        <div className="profile-page__field">
                            <span className="more_details">
                                <FaRegMoneyBillAlt /> Roll No:{" "}
                                {decoded.roll_number}{" "}
                            </span>
                        </div>
                    </div>
                    <div className="rightpart">
                        <div className="profile-page__field">
                            <span className="more_details">
                                <FaHome /> Hostel: {decoded.hostel}
                            </span>
                        </div>
                        <div className="profile-page__field">
                            <span className="more_details">
                                <FaMapMarkerAlt /> Room Number:{" "}
                                {decoded.room_number}
                            </span>
                        </div>
                    </div>
