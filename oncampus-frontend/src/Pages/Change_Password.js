...
//FUCNTION TO DISPATCH ACTION
    ...
    return ( 
        ...
        <div style={style.cont} className="otp-container">
            ...
            <p style={{fontSize:'1.3rem',fontWeight:'700', marginTop:"4rem"}}>
               RESET PASSWORD
            </p>
            <input style={{fontFamily: "Inter, monospace", width:'12rem',height:'2rem'}} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Current Password"/>
            <input style={{fontFamily: "Inter, monospace", width:'12rem',height:'2rem'}} onChange={(e)=>setNewPassword(e.target.value)} type="password" placeholder="New Password"/>
            <LoadingButton
                style={{width:'13rem',color:'white',fontFamily: "Inter, monospace",background:'#181818',borderRadius:'10px',marginBottom:'3rem',height:'2.5rem',fontWeight:'700'}}
