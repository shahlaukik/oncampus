...
function ProductDetails() {
    ...
    const handleConnectionRequest = async (e) => {
        if (e.target.value === "true") {
            ...
            const res = await axios.post(
                "http://localhost:8080/chats/get-or-create-chat-room",
                data,
                {
                    headers: {
    ...
    return (
        <div>
            ...
            <div className="container09" style={{ marginTop: "2rem" }}>
                {isLoading ? (
                    <LoadingBox />
                ) : (
                    <div className="containerWrapper">
                        ...
                        <div className="owner">
                                ...
                                <div className="detailsContainer">
                                    ...
                                    <div className="description">
                                        ...
                                        <p style={{ marginTop: "5px" }}>
                                            ...
                                            {
                                                singleProduct.bought_datetime?.split(
                                                    "T"
                                                )[0]
                                            }
                                        </p>
                                        <p style={{ marginTop: "5px" }}>
                                            ...
                                            {
                                                singleProduct?.warranty_till?.split(
                                                    "T"
                                                )[0]
                                            }
                                        </p>
                            ...
                            >
                                ...
                                >
                                    <h4 style={{marginTop:"1rem"}}>Connect with this item seller</h4>
                                    <p
                                        style={{
                                            marginTop: "2%",
                                            marginBottom: "2%",
